...
export const colors = {
  ...
  ink: '#101418', //          17.41:1 ✅ texto principal
  inkSecondary: '#4A5259', //  7.48:1 ✅ texto de apoio, rótulos
  inkMuted: '#666C73', //      4.99:1 ✅ legendas (era #ABB5BE, 2.08:1)
  inkOnAction: '#0A1A0C', //  11.77:1 ✅ sobre `action` (não sobre background)
  inkInverse: '#FFFFFF', //           ✅ sobre superfícies escuras

  // ── Marca ─────────────────────────────────────
  primary: '#1CA625', //  3.03:1 ⚠️ SÓ ícones e bordas, e SÓ sobre `surface`
  actionInk: '#0E7A16', // 5.18:1 ✅ verde quando é TEXTO
  action: '#0DF205', //    1.53:1 ⛔ NUNCA texto — só preenchimento

  // ── Superfícies ───────────────────────────────
  background: '#F7F8FA', //   o neutro dos 60% (antes por tokenizar, 15 usos)
  surface: '#FFFFFF', //      cartões — 1.06:1 vs background
  surfaceSunken: '#EDF1F3', // campos inativos, esqueletos

  // ── Limites ───────────────────────────────────
  border: '#E3E7EB', //       1.24:1 hairline decorativa (cartões)
  borderStrong: '#7D848C', // 3.56:1 ✅ limites de controlo (inputs, checkbox)
  borderFocus: '#0E7A16', //  5.18:1 ✅ anel de foco, 2px

  // ── Semântica (par superfície + tinta) ────────
  success: '#0E7A16', //        5.18:1 ✅
  successSurface: '#E7F8E8', // par de `success` → 4.98:1 ✅
  warning: '#8A5A00', //        5.58:1 ✅
  warningSurface: '#FDF3D9', // par de `warning` → 5.36:1 ✅
  danger: '#C62828', //         5.29:1 ✅
