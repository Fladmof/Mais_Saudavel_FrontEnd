    ...
    return (
        <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: 10 }}>
            ...
            <View style={{
                ...
                <Text style={{ color: '', maxWidth: 250 }}>{message}</Text>
            </View>
        </View>
    )
}
    ...
    return (
        <View style={{ display: 'flex', flexDirection: 'row', alignSelf: 'flex-end', gap: 10 }}>
            <View style={{
                ...
                <Text style={{ color: 'white', maxWidth: 250 }}>{message}</Text>
            </View>
            <View style={{
            ...
            <ScrollView contentContainerStyle={{
                ...
                <View>
                    ...
                    <View style={{
                        ...
                        <PacienteMessage message={'vou tomar este remédio por agora e depois irei descnansar por umas horas e despertar'} id='ufhuuf' />
                        <DoctorMessage message={'sim este mesmo e melhor dormir mesmo para evitar fadiga'} id='ufhu98684f' />
